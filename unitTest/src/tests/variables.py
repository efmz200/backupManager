mariaResult = [(1, 'Juan', 25, 'juan@example.com'),
                (2, 'María', 30, 'maria@example.com'), 
                (3, 'Carlos', 40, 'carlos@example.com')]

mongoResult = [{'_id': 'U1IT00001', 'item_name': 'Blender', 'max_discount': '10%', 'batch_number': 'RR450020FRG', 'price': 340, 'category': 'kitchen appliance'},
